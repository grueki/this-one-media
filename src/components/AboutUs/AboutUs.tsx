...
export const AboutUs = () => {
    return(
        <Container w={800} my={100}>
            <Text ta={"center"} ff={"'Open Sans', sans-serif"}>
            ...
            <br/><br/>
            These days staying relevant online is vital for success and in the digital space good content has always been king. Give your brand image the upgrade it deserves. Get in touch and let’s make something great together!
            <br/><br/>
            Which media company should you hire for your next project? The answer is simple… 
            <br/><br/>
            This One.
            </Text>
        </Container>
